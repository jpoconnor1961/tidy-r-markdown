...
```{r reorder_country_factor_levels}
ilo_data <- ilo_data %>%
...
```{r producing_the_plot, fig.height = 8, fig.width = 4.5, fig.align = "center"}
...
(You can right-click on the figure and save it for dissemination on Social Media.)
